...
Enter-PSSession -ComputerName 3.128.112.87 -Credential $credential
# Create web server
 ...
 Write-Output '<head>HTML Example</head><br><body>testtask (Prod_AWS)</body>' |out-file .\testtask\index.html
